...
echo '已完成 ---- 消融实验-00/case study ----- 不re-weighting,但保留inference（看看是否是个性化的sentiment带来的性能提升！！！）'
#python main.py train --model=MSCI0D0T0 --lambda=0.5 --dataset=Gourmet_Food_data --inference='trans-PD'
