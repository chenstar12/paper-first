...
class MSCI9C(nn.Module):

    def __init__(self, opt):
        super(MSCI9C, self).__init__()
        self.opt = opt
...
class Net(nn.Module):
    ...
    def forward(self, doc, reviews, ids, ids_list, sentiments):  # 添加了sentiments
        ...
        r_fea = r_fea * polarity_w * r_num  # fea还是[128, 10/27, 132]
        ...
        r_fea = r_fea * att_weight  # fea:[128, 10/27, 100]; 得到r_fea也是[128, 10, 100]；原理：最后一维attention自动扩展100次
