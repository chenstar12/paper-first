...
python main.py train --model=MSCI --num_fea=2 --ui_merge=dot --output=mlp --dataset=Video_Games_data --batch_size=512 --lr=5e-3
python main.py train --model=MSCI --num_fea=2 --ui_merge=dot --output=mlp --dataset=Video_Games_data --batch_size=512 --lr=6e-3
python main.py train --model=MSCI --num_fea=2 --ui_merge=dot --output=mlp --dataset=Video_Games_data --batch_size=512 --lr=7e-3
python main.py train --model=MSCI --num_fea=2 --ui_merge=dot --output=mlp --dataset=Video_Games_data --batch_size=512 --lr=8e-3
